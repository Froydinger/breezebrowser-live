...
(function () {
  ...
  window.breezeInternal = {
    ...
    getAIImages: function () { return call('getAIImages'); },
    downloadAIImage: function (path) { send('downloadAIImage', { path: path }); },
    ...
    getActivity: function () { return call('getActivity'); },
    onActivity: function (cb) { window.__bzOnActivity = cb; },
    freeUpMemory: function () { return call('freeUpMemory'); },
    ...
    isDefaultBrowser: function () { return call('isDefaultBrowser'); },
    makeDefaultBrowser: function () { return call('makeDefaultBrowser'); },
    ...
    getSummaries: function () { return call('getSummaries'); },
    openSummary: function (file) { send('openSummary', { file: file }); },
    deleteSummary: function (id) { send('deleteSummary', { id: id }); },
